...
public class RB_SP extends SettingPanel {
	...
	//Vector<String> radios = new Vector<String>();
	
	JTable table;
	RadioTableModel model;
	
	public RB_SP(JPanel parent, FormElement fe) {
		...
		/*for(JRadioButton s : fe.radioButtons) {
			
			radios.add(s.toString());
			
		}*/
		

		model = new RadioTableModel(element.rbModel,element);
